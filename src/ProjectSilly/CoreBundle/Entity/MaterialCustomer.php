...
/**
 * @ORM\Table(name="material_customers")
 * @ORM\Entity()
 * @ORM\HasLifecycleCallbacks()
 */
class MaterialCustomer {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ProjectSilly\CoreBundle\Entity\Material", inversedBy="materialCustomer")
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ProjectSilly\CoreBundle\Entity\Customer", inversedBy="materials")
