 ...
 */
class Version20160704204738 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers CHANGE quantity quantity NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers CHANGE quantity quantity NUMERIC(2, 1) NOT NULL');
