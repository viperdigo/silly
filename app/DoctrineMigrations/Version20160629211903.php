 ...
 */
class Version20160629211903 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE areas CHANGE ugr ugr enum(\'santana\',\'freguesia\',\'pirituba\',\'extremo norte\',\'bragantina\'), CHANGE `release` liberation enum(\'yes\',\'no\',\'ploy\')');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE areas CHANGE ugr ugr VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, CHANGE liberation `release` VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
