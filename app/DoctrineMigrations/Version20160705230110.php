 ...
 */
class Version20160705230110 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customers CHANGE document document VARCHAR(13) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customers CHANGE document document VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
