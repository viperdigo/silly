 ...
 */
class Version20160706105047 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers ADD date_application DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE material_public_places ADD date_application DATE DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers DROP date_application');
        $this->addSql('ALTER TABLE material_public_places DROP date_application');
