 ...
 */
class Version20160705234339 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers ADD unit_measurement enum(\'unit\',\'meter\',\'piece\',\'cubic meter\')');
        $this->addSql('ALTER TABLE material_public_places ADD unit_measurement enum(\'unit\',\'meter\',\'piece\',\'cubic meter\')');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE material_customers DROP unit_measurement');
        $this->addSql('ALTER TABLE material_public_places DROP unit_measurement');
